...
import { fetchAllHostels, getAllHostelsData } from '../../../features/dashboard/AdminSlice';
      ...
      <DashboardLayout>
        <div className='flex justify-between my-5'>
          <div className="px-4 sm:px-0">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Hostels</h3>
            <p className="mt-1 text-sm text-gray-600">You can manage hostels that you own from this panel</p>
          </div>
          <div className="px-4 sm:px-0">
            <PrimaryLinkButton goto="add" title="Add New Hostel"></PrimaryLinkButton>
          </div>
        </div>
        {/* Table */}
