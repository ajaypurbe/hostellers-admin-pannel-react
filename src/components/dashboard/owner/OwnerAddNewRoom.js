...
import {addRoom, fetchAllCategories, fetchAllRoomClass, fetchAllType, getAllCategoriesData, getAllRoomClassData, getTypeData, fetchAllHostelsOfCurrentUser, getAllHostelsDataOfCurrentUser} from "../../../features/dashboard/AdminSlice";
...
export default function OwnerAddNewRoom() {
  ...
  console.log("Room clas", allClasses);
  ...
  const handleFormDataChanges = (e) => {
    return new Promise((resolve, reject) => {
      ...
      formData.append('uid', currentUser._id);
      formData.append('hostelId', e.target.hostelName.value);
      formData.append('title', e.target.roomName.value);
      ...
      formData.append('galleryImages', e.target.galleryImages.files);
      formData.append('contactEmail', [e.target.emailAddress.value]);
      formData.append('phoneNumber', [e.target.phoneNumber.value]);
      formData.append('tel', [e.target.telNumber.value]);
      formData.append('roomType', e.target.roomType.value);
      formData.append('classId', e.target.roomClass.value);
      formData.append('studentCapacity', e.target.roomCapacity.value);
      formData.append('totalBeds', e.target.bedCapacityPerRoom.value);
      formData.append('categoryId', e.target.roomCategory.value);
      formData.append('roomSize', e.target.roomArea.value);
      formData.append('facilities', faclitiesList);
      formData.append('coordinates', currentCoordinate);
      formData.append('city', e.target.city.value);
      formData.append('country', e.target.country.value);
      formData.append('province', e.target.province.value);
      formData.append('zip', e.target.postalCode.value);
      formData.append('place', e.target.place.value);
      formData.append('street', e.target.streetAddress.value);
                        ...
                        <div className="mt-1 mx-8 my-4 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                          <div className="space-y-1 text-center">
                            ...
                            <div className="flex text-sm text-gray-600">
                              ...
                              >
                                <span>Upload a file</span>
                                <input id="coverImage" name="coverImage" type="file" className="sr-only" />
                              </label>
                              <p className="pl-1">or drag and drop</p>
                            </div>
                            <p className="text-xs text-gray-500">PNG, JPG, GIF up to 10MB</p>
                        ...
                        <div className="mt-1 mx-8 my-4 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                          <div className="space-y-1 text-center">
                            ...
                            <div className="flex text-sm text-gray-600">
                              ...
                              >
                                <span>Upload a file</span>
                                <input id="galleryImages" name="galleryImages" type="file" multiple className="sr-only" />
                              </label>
                              <p className="pl-1">or drag and drop</p>
                            </div>
                            <p className="text-xs text-gray-500">PNG, JPG, GIF up to 10MB</p>
