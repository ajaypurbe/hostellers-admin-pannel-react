...
import { addType, getLoadingStatus} from "../../../features/dashboard/AdminSlice";


export default function AdminAddNewHostelType() {
  ...
  const handleFormDataChanges = () => {
    return new Promise((resolve, reject) => {
      ...
      formData.append('typeImage', profileImageFormData, profileImageFormData.name);
      formData.append('typeBanner', bannerImageFormData, bannerImageFormData.name);
      formData.append('typeName', typeData.typeName);
      formData.append('typeDescription', typeData.typeDescription);
      resolve(formData);
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    if (profileImageFormData &&bannerImageFormData && typeData.typeName !== "" && typeData.typeDescription !== "") {

      const result = await dispatch(addType(await handleFormDataChanges()));
      console.log(result);
  ...
  const onChangeHandlerTypeName = (e) => {
    settypeData({...typeData,typeName:e.target.value});
    
  }
  
  const onChangeHandlerTypeDescription = (e) => {
    settypeData({...typeData,typeDescription:e.target.value});
  }
            ...
            <div className="md:grid md:grid-cols-1 md:gap-6">
              ...
              <div className="mt-5 md:mt-0 md:col-span-1">
                ...
                <div className="shadow mt-5 overflow-hidden sm:rounded-md">
                  <SectionTitle title="Add Hostel Type"></SectionTitle>
                  ...
                  <div className="px-4 py-5 bg-white sm:p-6">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-6">
                        ...
                        <p className='text-xs italic'>Eg. Boys, Girls</p>
                        <input
                          onChange={onChangeHandlerTypeName}
                          type="text"
                          name="type"
                          id="type"
                      ...
                      <div className="col-span-6 sm:col-span-6">
                        <label htmlFor="type-description" className="block text-sm font-medium text-gray-700">
                          Type Description
                        </label>
                        <textarea
                          onChange={onChangeHandlerTypeDescription}
                          type="text"
