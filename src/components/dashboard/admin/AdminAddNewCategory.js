...
import { addCategory, getLoadingStatus, setCategoryData, getCategoryData } from "../../../features/dashboard/AdminSlice";
...
export default function AdminAddNewCategory() {
  ...
  const handleFormDataChanges = () => {
    return new Promise((resolve, reject) => {
      ...
      formData.append('categoryImage', profileImageFormData, profileImageFormData.name);
      formData.append('categoryBanner', bannerImageFormData, bannerImageFormData.name);
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    if (profileImageFormData && categoryData.categoryName !== "" && categoryData.categoryDescription !== "") {

      const result = await dispatch(addCategory(await handleFormDataChanges()));
      console.log(result);
  ...
  const onChangeHandlerCategoryName = (e) => {
    dispatch(setCategoryData({ ...categoryData, categoryName: e.target.value }));

  }

  const onChangeHandlerCategoryDescription = (e) => {
    dispatch(setCategoryData({ ...categoryData, categoryDescription: e.target.value }));
            ...
            <div className="md:grid md:grid-cols-1 md:gap-6">
              ...
              <div className="mt-5 md:mt-0 md:col-span-1">
                ...
                <div className="shadow mt-5 overflow-hidden sm:rounded-md">
                  <SectionTitle title="Add Category"></SectionTitle>
