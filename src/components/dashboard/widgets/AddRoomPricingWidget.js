...
import {
    ...
    setTitle,
    getsinglePricingId,
    clearSinglePricingId
} from "../../../features/rooms/roomPricingSlice";
...
function AddRoomPricingWidget() {
    const dispatch = useDispatch();

    const roomPricings = useSelector(getroomPricings);
    ...
    const singlePricingId = useSelector(getsinglePricingId);
    ...
    const onClickAddPricingHandler = async (e) => {
        if (title !== "" && description !== "" && rate !== "" && duration !== "" && currency !== "" && features.length > 0) {
            dispatch(setPricing({
                "oldPricingData": roomPricings, "pricingData": {
                    _id: generateUUID(),
                    title: title,
            ...
            const result = await dispatch(addRoomPricing(payload));
            ...
            <div className='grid grid-cols-6 gap-6'>
                ...
                <div className='col-span-2' >
                    ...
                    <div className='my-4'>
                        <button
                            type='button'
                            onClick={onClickAddPricingHandler}
                                ...
                                <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {roomPricings.length > 0 ? roomPricings.map((pricing) => (
                                                <tr key={pricing._id}>
...
export default AddRoomPricingWidget;